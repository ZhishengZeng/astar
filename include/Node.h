...
class Node
{
 public:
  ...
  int get_known_cost() const { return _known_cost; }
  int get_est_cost() const { return _est_cost; }
  ...
  void set_known_cost(const int known_cost) { _known_cost = known_cost; }
  void set_est_cost(const int est_cost) { _est_cost = est_cost; }
