...
// {
//   astar::Model astar_model;
//   astar_model.buildMap(4, 4);
//   astar_model.setLogVerbose(2);

//   astar_model.addNodeCost({0, 0}, 0.1);
//   astar_model.addNodeCost({0, 1}, 0.5);
//   astar_model.addNodeCost({0, 2}, 0.1);
//   astar_model.addNodeCost({0, 3}, 0.2);

//   astar_model.addNodeCost({1, 0}, 0.1);
//   astar_model.addNodeCost({1, 1}, 0.4);
//   astar_model.addNodeCost({1, 2}, 0.2);
//   astar_model.addNodeCost({1, 3}, 0.1);

//   astar_model.addNodeCost({2, 0}, 0.2);
//   astar_model.addNodeCost({2, 1}, 0.8);
//   astar_model.addNodeCost({2, 2}, 0.8);
//   astar_model.addNodeCost({2, 3}, 0.3);

//   astar_model.addNodeCost({3, 0}, 0.1);
//   astar_model.addNodeCost({3, 1}, 0.7);
//   astar_model.addNodeCost({3, 2}, 0.5);
//   astar_model.addNodeCost({3, 3}, 0.5);

//   astar_model.getPath({0, 0}, {3, 3});
//   return 0;
// }
...
int main()
{
  ...
  astar_model.addNodeCost({0, 0}, 1);
  astar_model.addNodeCost({0, 1}, 2);
  astar_model.addNodeCost({0, 2}, 1);
  astar_model.addNodeCost({0, 3}, 1);

  astar_model.addNodeCost({1, 0}, 1);
  astar_model.addNodeCost({1, 1}, 2);
  astar_model.addNodeCost({1, 2}, 1);
  astar_model.addNodeCost({1, 3}, 1);

  astar_model.addNodeCost({2, 0}, 1);
  astar_model.addNodeCost({2, 1}, 3);
  astar_model.addNodeCost({2, 2}, 3);
  astar_model.addNodeCost({2, 3}, 1);

  astar_model.addNodeCost({3, 0}, 1);
  astar_model.addNodeCost({3, 1}, 3);
  astar_model.addNodeCost({3, 2}, 2);
  astar_model.addNodeCost({3, 3}, 2);
